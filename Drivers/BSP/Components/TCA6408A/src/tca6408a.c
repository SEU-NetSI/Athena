...
{
	*reg_value=i2cdevReadReg8(I2C1, I2C_EXPANDER_DEFAULT_I2C_ADDRESS, reg_address);
...
bool I2C_expander_set_output_pin(uint8_t pin_number,bool pin_state)
{
    ...
    output_reg_value= i2cdevReadReg8(I2C1, I2C_EXPANDER_DEFAULT_I2C_ADDRESS, OUTPUT_PORT_REG_ADDRESS);
    ...
    //update reg value
    i2cdevWriteReg8(I2C1, I2C_EXPANDER_DEFAULT_I2C_ADDRESS, OUTPUT_PORT_REG_ADDRESS, output_reg_value);
...
bool I2C_expander_get_input_pin(uint8_t pin_number,bool* pin_state)
{
    ...
    input_reg_value= i2cdevReadReg8(I2C1, I2C_EXPANDER_DEFAULT_I2C_ADDRESS,INPUT_PORT_REG_ADDRESS);
    //mask selected pin
